    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/jquery-jvectormap-2.0.3.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/climacons.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/flag-icon.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/datatable/dataTables.bootstrap4.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/css/datatable/buttons.dataTables.min.css">
	<link href="<?php echo base_url();?>assets/css/admin.css" rel="stylesheet">
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/jquery-confirm.min.css">
	<link href="<?php echo base_url(); ?>assets/css/datepicker/datepicker.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url(); ?>assets/css/datepicker/timepicker.css" rel="stylesheet" type="text/css" >
