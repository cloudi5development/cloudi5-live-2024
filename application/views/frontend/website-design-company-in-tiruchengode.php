...
<html lang="en">
    <head>
        ...
        <title>Web Design Company in Tiruchengode | Website Design Tiruchengode - Cloudi5</title>
        <meta name="description" content="Cloudi5 - The best Web design company in Tiruchengode design professional and ecommerce websites with expertise that helps to elevate your business." />
        <meta name="keywords" content="web design company in Tiruchengode, website design companies, website design in Tiruchengode, web design companies in Tiruchengode, Web Hosting, ecommerce design, corporate design, Web design companies in India, UK, US, Canada, Middle East Countries, best branding companies in Tiruchengode, Website design, web page, top web design companies, Web design, Restuarants, Shopping sites, Taxi, Travels, Education sites design, Construction, Real estate website design, Hotel Booking website design" />
        <link rel="canonical" href="<?php echo base_url(); ?>/website-design-company-in-tiruchengode" />
		<meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design Company in Tiruchengode | Website Design Tiruchengode - Cloudi5" />
        <meta property="og:description" content="Cloudi5 - The best Web design company in Tiruchengode design professional and ecommerce websites with expertise that helps to elevate your business." />
        <meta property="og:url" content="<?php echo base_url(); ?>/website-design-company-in-tiruchengode" />
        <meta name="robots" content="index,follow" />
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <link rel="alternate" href="<?php echo base_url();?>website-design-company-in-tiruchengode" hreflang="x-default" />
        <link rel="icon" href="<?php echo base_url();?>asset/images/favicon.png" />
        <link rel="stylesheet" href="<?php echo base_url();?>asset/css/bootstrap.min.css" />
        <!-- FontAwesome - For Menu -->
        <link rel="stylesheet" href="<?php echo base_url();?>asset/css/font-awesome.min.css" />
        <!--<link rel="stylesheet" href="<?php echo base_url();?>asset/fonts/themify-icons.css" />-->
    ...
    <body id="cont1">
        ...
        <div class="body-inner body-bg-1" id="">
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="banner_iner">
                                <h1 class="text-gray-extra-dark no-margin-bottom"><span class="text-gradient-red">Website Design</span> Company in Tiruchengode </h1>
                                <p class="wow fadeInLeft" data-wow-delay=".5s">Building Websites that Build Brand Image and Customer Engagement Rate</p>
                                <div class="banner_btn">
                                    <a href="<?php echo base_url();?>contactus" class="btn grdnt-purple ecom-ban-btn-txt" data-wow-delay=".5s" style="padding:10px 20px 10px 48px !important;"><span class="btn-pulso"></span> Get started</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-7 wow fadeInDown" data-wow-delay=".5s">
                            <div class="banner_img">
                                <img src="<?php echo base_url();?>asset/images/wd-page/banner-img.png" alt="#" class="img-fluid" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="services_content_iner">
                                <div class="single_services_section wow fadeInDown" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInDown;">
                                    <a href="#" class="services_section_bg bg_1"></a>
                                    <div class="single_section_content">
                                        <h5>Unique Approach</h5>
                                        <h3><a href="#"> The unique work process is a standout factor that differentiates us from the rest. Our designers take utmost care of everything like no one else to make your site successful.</a></h3>
                                    </div>
                                </div>
                                <div class="single_services_section wow fadeInDown" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
                                    <a href="#" class="services_section_bg bg_2"></a>
                                    <div class="single_section_content">
                                        <h5>Quality Assurance (QA)</h5>
                                        <h3><a href="#"> Quality that speaks is the driving force of our success. We deploy and implement an enormous number of quality checkpoints before taking the website to live servers.</a></h3>
                                    </div>
                                </div>
                                <div class="single_services_section wow fadeInDown" data-wow-delay=".7s" style="visibility: visible; animation-delay: 0.7s; animation-name: fadeInDown;">
                                    <a href="#" class="services_section_bg bg_3"></a>
                                    <div class="single_section_content">
                                        <h5>Customer Satisfaction</h5>
                                        <h3><a href="#"> Our organization works passionately to earn customers satisfaction from everyone we work. We are committed to building sites that meet your expectations. </a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="pos-r">
                <div class="container">
                    <div class="wow fadeInLeft animated" data-wow-delay="0ms" data-wow-duration="1500ms" style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInLeft;">
                    <div class="text-center">
                        <h2 class="wd-title">Our Design Principles</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-sm-6 mt-5">
                            <div class="featured-item style-3">
                                ...
                                <div class="featured-title"><h5>Creative Designs</h5></div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt-5">
                            <div class="featured-item style-3">
                                <div class="featured-icon"><i class="flaticon-ui"></i><span class="border-anim"></span></div>
                                <div class="featured-title"><h5>SEO friendly Website design</h5></div>
                                <div class="featured-desc">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt-5">
                            <div class="featured-item style-3">
                                <div class="featured-icon"><i class="flaticon-ui"></i><span class="border-anim"></span></div>
                                <div class="featured-title"><h5>Responsive Design</h5></div>
                                <div class="featured-desc">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt-5">
                            <div class="featured-item style-3">
                                <div class="featured-icon"><i class="flaticon-ui"></i><span class="border-anim"></span></div>
                                <div class="featured-title"><h5>Information Architecture (IA)</h5></div>
                                <div class="featured-desc">
            ...
            <section class="process-section">
                ...
                <div class="auto-container">
                    <div class="sec-title style-two centered text-center">
                        <h2 class="wd-title">Our Process</h2>
            ...
            <section class="webinar-area">
                <div class="row m-0">
                    <div class="col-lg-6 p-0">
                        <div class="webinar-video-image-1 wow slideInLeft animated">
                            <img src="<?php echo base_url();?>asset/images/wd-page/box1.jpg" alt="image">
                        </div>
                    </div>
                ...
                <div class="row m-0">
                    <div class="col-lg-6 p-0">
                        <div class="webinar-content">
                            ...
                            <p>Website redesign enhances the visually appealing and usability features of a site. Our redesigning services deploy the latest designs and technologies to create faster loading responsive web designs for the existing sites, and few SEO aspects are added to the redesigned one. Maintenance services help to increase and sustain customer engagement rates by providing regular website and technical updates, checks for broken links, images, and the functionality of databases etc.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 p-0">
                        <div class="webinar-video-image wow slideInRight animated">
                            <img src="<?php echo base_url();?>asset/images/wd-page/box2.jpg" alt="image">
                        </div>
                    </div>
                </div>
            </section>
            <section class="section is-sm is-dark section-call2action">
                <div class="container">
                    <div class="call2action-box flex vcenter">
                        <div class="col-sm-4">
                            <div class="box-left">
                                <img class="screen" src="<?php echo base_url();?>asset/images/wd-page/call2action.png" alt="" />
                            </div>
                        </div>
                        <div class="col-sm-7">
                            <div class="box-right">
                                <div class="box-content">
                                    ...
                                    <p class="section-desc float-left">We make design that gives life to your business </p>
                                    <!-- <a href="" class="btn btn-white btn-outline"> Get Stared</a> -->
                                    <div class="float-right">
                                    <a href="<?php echo base_url();?>contactus" class="btn grdnt-purple">Contact Us</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
                            <div class="single_feature">
                                <div class="feature_img">
                                    <img data-animate="fadeInLeftBig" src="<?php echo base_url();?>asset/images/macbook-02.png" class="img-fluid fadeInLeftBig animated" alt="" />
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
                            <h2 class="line-height-1-42">Effective solution for every businesses</h2>
                            <div class="bkseparator--25"></div>
                            <p>Brook presents your services with flexible, convenient and multipurpose layouts. You can select your favorite layouts & elements for particular projects with unlimited customization possibilities.</p>
                            <a href="<?php echo base_url();?>contactus" class="btn grdnt-purple">Contact Us</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.1s" data-wow-offset="0">
                            <div class="single_feature mt_60">
                                ...
                                <p>Our expert team designs your websites using the latest technologies like HTML 4 & 5, Bootstrap, Angular and Vue.js and Content Management System (CMS) - WordPress, Shopify, Magento and Joomla. We deploy PHP frameworks like Laravel and CodeIgniter for Web Development.</p>
                                <!-- <ul>
                                    <li><span class="ti-check"></span>There are many variations of passages</li>
                                    <li><span class="ti-check"></span>If you are going to use a passage of Lorem Ipsum, you need to be sure</li>
                                    <li><span class="ti-check"></span>All the Lorem Ipsum generators on the Internet tend</li>
                                    <li><span class="ti-check"></span>If you use this site regularly and would like to help</li>
                                </ul> -->
                            </div>
                        </div>
                        <!-- END COL -->
                        <div class="col-lg-6 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.3s" data-wow-offset="0">
                            <div class="feature_img">
                                <img data-animate="fadeInLeftBig" src="<?php echo base_url();?>asset/images/wd-page/icon.png" class="img-fluid fadeInLeftBig animated" alt="" />
                            </div>
                        </div>
                        <!-- END COL -->
                    </div>
          ...
          <!--MixitUp Galery-->
            ...
            <section class="video-section" style="background-image:url(<?php echo base_url();?>asset/images/wd-page/3.jpg)">
				<div class="container">
            ...
            <!-- Color box-->
            <script type="text/javascript" src="<?php echo base_url();?>asset/js/jquery.colorbox.js"></script>
            <!-- Smoothscroll-->
        	...
        	})(window,document,'script','dataLayer','GTM-TTPGBC2');</script>
...
"url": "<?php echo base_url(); ?>/website-design-company-in-Tiruchengode",
...
"description": "Cloudi5 a leading Web design company in Tiruchengode design websites with expertise that helps to elevate your business. Contact Us For More Information!",
