...
<html lang="en">
    <head>
        ...
        <title>Web Design Company in Avinashi | Website Design Avinashi - Cloudi5</title>
        <meta name="description" content="Cloudi5 the best Web design company in Avinashi, We design websites with expertise that helps to elevate your business. Contact Us For More Information!" />
        <meta name="keywords" content="web design company in Avinashi, website design companies, website design in Avinashi, web design companies in Avinashi, Web Hosting, ecommerce design, corporate design, Web design companies in India, UK, US, Canada, Middle East Countries, best branding companies in Avinashi, Website design, web page, top web design companies, Web design, Restuarants, Shopping sites, Taxi, Travels, Education sites design, Construction, Real estate website design, Hotel Booking website design" />
        <link rel="canonical" href="<?php echo base_url(); ?>/website-design-company-in-avinashi" />
		<meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design Company in Avinashi | Website Design Avinashi - Cloudi5" />
        <meta property="og:description" content="Cloudi5 the best Web design company in Avinashi, We design websites with expertise that helps to elevate your business. Contact Us For More Information!" />
        <meta property="og:url" content="<?php echo base_url(); ?>/website-design-company-in-avinashi" />
        <meta name="robots" content="index,follow" />
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <link rel="alternate" href="<?php echo base_url();?>website-design-company-in-avinashi" hreflang="x-default" />
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="banner_iner">
                                <h1 class="text-gray-extra-dark no-margin-bottom"><span class="text-gradient-red">Website Design</span> Company in Avinashi </h1>
...
"url": "<?php echo base_url(); ?>/website-design-company-in-Avinashi",
...
"description": "Cloudi5 a leading Web design company in Avinashi design websites with expertise that helps to elevate your business. Contact Us For More Information!",
