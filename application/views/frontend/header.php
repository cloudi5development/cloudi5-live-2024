...
?>
  <div class="site-top">
                     ...
                     <ul class="top-info">
                        <li><span class="info-icon"><i class="icon icon-phone3"></i></span>
                           <div class="info-wrapper">
                              <p class="info-title">Sales: <a href="tel:<?php echo str_replace(' ', '', $header_setting->mobile_2); ?>" class="tel btns callus"><?php echo $header_setting->mobile_2; ?></a></p>
                           </div>
                        </li>
                        <li class="hide-mob last part_hide"><span class="info-icon"><i class="icon icon-map-marker2"></i></span>
                           <div class="info-wrapper">
                              <p class="info-title">MK SQURE, <?php echo $header_setting->address_3 .' '. $header_setting->city ?> </p>
                           </div>
                        </li>
                     </ul>
                  </div>
                     ...
                     <ul class="top-social">
                        <li>
                           ...
                           <a title="Twitter" href="<?php echo $header_setting->twitter; ?>" rel="nofollow" target="_blank">
                            <span class="social-icon"><img src="https://www.cloudi5.com/asset/images/twitter-white-logo.png" style="height:14px;"></span>
                         </a>
                         <a title="Instagram" href="<?php echo $header_setting->instagram; ?>" rel="nofollow" target="_blank">
                         ...
                         <!--</a>-->
                         <a title="Pinterest" href="<?php echo $header_setting->pinterest; ?>" rel="nofollow" target="_blank">
                            <span class="social-icon"><i class="fa fa-pinterest"></i></span>
                         </a>
                         <a title="Youtube" href="<?php echo $header_setting->youtube; ?>" rel="nofollow" target="_blank">
                            <span class="social-icon"><i class="fa fa-youtube"></i></span>
                         </a>
                         <a title="thread" href="<?php echo $header_setting->google_plus; ?>" rel="nofollow" target="_blank">
                            <span class="social-icon"><img src="https://www.cloudi5.com/asset/images/thread-icon.png"></span>
                         </a>
                        </li>
                     </ul>
                  </div>
         ...
         <header class="header-standard header-transparent" id="header"><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
            <div class="container">
                     ...
                     <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                           ...
                           <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Company<i class="fa fa-angle-down"></i></a>
                            ...
                            <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Services<i class="fa fa-angle-down"></i></a>
                              <ul class="dropdown-menu" role="menu">
                                 ...
                                 <li><a href="<?php echo base_url();?>mobile-application-development-android-app">Android Application Development</a></li>
                                 <li class="nav-item"><a href="<?php echo base_url();?>digital-marketing-company-in-coimbatore">Digital Marketing</a></li>
                           ...
                           <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Products<i class="fa fa-angle-down"></i></a>
                              <ul class="dropdown-menu" role="menu">
                                   <li class="nav-item"><a href="<?php echo base_url();?>school-management-software">School Management Software</a></li>
                                   <li class="nav-item"><a href="<?php echo base_url();?>ecommerce-website-development">Multi Vendor Ecommerce Website</a></li>
                              </ul>
                           </li>
