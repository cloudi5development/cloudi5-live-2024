...
<html lang="en">
    <head>
        ...
        <title>Web Design Company in Tirupur | Website Design Tirupur - Cloudi5</title>
        <meta name="description" content="Cloudi5 a leading Web design company in Tirupur. We design Professional and eCommerce websites with expertise that helps to elevate your business." />
        <meta name="keywords" content="best web design company in Tirupur, website design companies, website design in Tirupur, web design companies in Tirupur, Web Hosting, ecommerce design, corporate design, Web design companies in India, UK, US, Canada, Middle East Countries, best branding companies in Tirupur, Website design, web page, top web design companies, Web design, Restuarants, Shopping sites, Taxi, Travels, Education sites design, Construction, Real estate website design, Hotel Booking website design" />
        <link rel="canonical" href="<?php echo base_url(); ?>/website-design-company-in-tirupur" />
		<meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design Company in Tirupur | Website Design Tirupur - Cloudi5" />
        <meta property="og:description" content="Cloudi5 a leading Web design company in Tirupur. We design Professional and eCommerce websites with expertise that helps to elevate your business." />
        <meta property="og:url" content="<?php echo base_url(); ?>/website-design-company-in-tirupur" />
        <meta name="robots" content="index,follow" />
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <link rel="alternate" href="<?php echo base_url();?>website-design-company-in-tirupur" hreflang="x-default" />
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="banner_iner">
                                <h1 class="text-gray-extra-dark no-margin-bottom"><span class="text-gradient-red">Website Design</span> Company in Tirupur </h1>
...
"url": "<?php echo base_url(); ?>/website-design-company-in-Tirupur",
...
"description": "Cloudi5 a leading Web design company in Tirupur design websites with expertise that helps to elevate your business. Contact Us For More Information!",
