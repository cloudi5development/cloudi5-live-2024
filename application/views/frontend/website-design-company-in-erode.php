...
<html lang="en">
    <head>
        ...
        <title>Web Design Company in Erode | Website Design Erode - Cloudi5</title>
        <meta name="description" content="Cloudi5 - The Web design company in Erode design websites with expertise that helps to improve your business. Contact Us For More Information!" />
        <meta name="keywords" content="best web design company in Erode, website design companies, website design in Erode, web design companies in Erode, Web Hosting, ecommerce design, corporate design, Web design companies in India, UK, US, Canada, Middle East Countries, best branding companies in Erode, Website design, web page, top web design companies, Web design, Restuarants, Shopping sites, Taxi, Travels, Education sites design, Construction, Real estate website design, Hotel Booking website design" />
        <link rel="canonical" href="<?php echo base_url(); ?>/website-design-company-in-erode" />
		<meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design Company in Erode | Website Design Erode - Cloudi5" />
        <meta property="og:description" content="Cloudi5 - The Web design company in Erode design websites with expertise that helps to improve your business. Contact Us For More Information!" />
        <meta property="og:url" content="<?php echo base_url(); ?>/website-design-company-in-erode" />
        <meta name="robots" content="index,follow" />
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <link rel="alternate" href="<?php echo base_url();?>website-design-company-in-erode" hreflang="x-default" />
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="banner_iner">
                                <h1 class="text-gray-extra-dark no-margin-bottom"><span class="text-gradient-red">Website Design</span> Company in Erode </h1>
...
"url": "<?php echo base_url(); ?>/website-design-company-in-Erode",
...
"description": "Cloudi5 a leading Web design company in Erode design websites with expertise that helps to elevate your business. Contact Us For More Information!",
