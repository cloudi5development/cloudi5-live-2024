   ...
   <script type="application/ld+json" class="yoast-schema-graph">
      {
         ...
         "@graph": [{
            "@type": "WebSite",
            "@id": "https://www.cloudi5.com/#website",
            "url": "https://www.cloudi5.com/",
            "name": "Cloudi5 Technologies",
            "description": "",
            "potentialAction": [{
               "@type": "SearchAction",
               "target": {
                  "@type": "EntryPoint",
                  "urlTemplate": "https://www.cloudi5.com/?s={search_term_string}"
               },
            ...
            "@type": "WebPage",
            "@id": "https://www.cloudi5.com/#webpage",
            "url": "https://www.cloudi5.com/",
            "name": "Web Design Company in Coimbatore | Web Development",
            "isPartOf": {
               "@id": "https://www.cloudi5.com/#website"
            },
            "datePublished": "2023-01-23T01:27:41+00:00",
            "dateModified": "2023-05-26T06:24:00+00:00",
            "description": "The leading software, Web Design and Web Development in Coimbatore. Focusing on custom ERP & CRM, Mobile app, SEO, and E-commerce website",
            "breadcrumb": {
               "@id": "https://www.cloudi5.com/#breadcrumb"
            },
            "inLanguage": "en-US",
            "potentialAction": [{
               "@type": "ReadAction",
               "target": ["https://www.cloudi5.com/"]
            }]
         }, {
            "@type": "BreadcrumbList",
            "@id": "https://www.cloudi5.com/#breadcrumb",
   ...
   <div class="body-inner">
            ...
            <div class="row align-items-center">
               <div class="col-xxl-7 col-xl-7 col-lg-7">
                  <div class="slider-content">
                     ...
                     <div class="mb-30">
                        <p class="banner-text">Web Design, Web Development, Mobile App Development, Digital Marketing ✏️
                        </p>
                     </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center mb-4">
                  <div class="h4 lrg"> Coimbatore's Top <span class="theme-red-color"> Web Design and Development
                        Company</span></div><span class="red-border-line">&nbsp;</span>
                  <div>
                     <h4>Are you looking for a leading web design and development company in Coimbatore? Look no further
                        than Cloudi5! </h4>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-6">
                  <div>
                     <p class="text-indent-30">Cloudi5 Technologies is the <strong>Best Web Designing and Development
                        ...
                        solutions that are customized to your specific needs and budgets.</p>
                     <p>Beyond web design and web development, we offer an array of complementary services, including
                        Mobile App Development(Android & iOS), ERP Software development, CRM Software & Mobile App
                        Development, IoT Web & Mobile App Development, AI Web & Mobile App Development , E-Commerce
                        Website Development, and Digital Marketing. From inception to driving meaningful online
                        engagement, Cloudi5 is your end-to-end partner for all things digital.</p>
                  </div>
               </div>
               <div class="col-md-6">
      ...
      <section class="ts-intro" id="ts-intro">
         <div class="container">
            ...
            <div class="col-sm-12">
               ...
               <h1 class="small-heading">Intelligent Web Design, Mobile App and Strategic Digital Marketing Solutions
               </h1><br>
               <div class="row text-center">
                  <div class="col-sm-4 bor wwd-img">
                     ...
                     <p>Combining innovation expertise and the effective usage of technology we create the best web
                        applications for various segments of Business along with professional maintenance. </p>
                  </div>
                  <div class="col-sm-4 bor wwd-img">
                     ...
                     <p>Expand your Business with a user-friendly custom mobile app development and grow your customer
                        base by converting all smartphone users into your loyal customers. </p>
                  </div>
                  <div class="col-sm-4 wwd-img">
                     ...
                     <p>An innovative and agile approach is essential to have the maximum Brand impact in the market and
                        with customers. We help you to re-think strategies that work well for your Business. </p>
                  </div>
                     ...
                     <div class="tab-content">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-5 align-self-center">
                                 ...
                                 <div class="bg-contain-verticle align-self-center">
                                    <img class="img-center img-fluid lazy" alt="IoT Application Development Company"
                                       src="<?php echo base_url();?>asset/images/default_image.png"
                        ...
                        <div class="tab-pane animated fadeInRight" id="tab_three">
                           <div class="row">
                              <div class="col-lg-5 align-self-center">
                                 <div class="bg-contain-verticle">
                                    <img class="img-center img-fluid lazy" alt="Custom Software Development Company"
                                       src="<?php echo base_url();?>asset/images/default_image.png"
                              ...
                              <div class="col-lg-7">
                                 <div class="tab-content-info">
                                    ...
                                    <p class="para-align-justify">Custom software serves the sole processes of your
                                       business, solves your exact problems, meets your needs and makes your workflows
                                       easier, faster, and more efficient. Moreover, we deliver perfect UX, flawless
                                       integration, entire information security, software support & maintenance.</p>
                        ...
                        <div class="tab-pane animated fadeInRight" id="tab_four">
                           <div class="row">
                              ...
                              <div class="col-lg-5 align-self-center">
                                 <div class="bg-contain-verticle">
                                    <img class="img-center img-fluid lazy" alt="Hire Software Application Developers"
                                       src="<?php echo base_url();?>asset/images/default_image.png"
         ...
         <div class="container">
            ...
            <div class="mixitup-gallery" style="padding-top: 30px">
               ...
               <div class="filter-list row clearfix" id="MixItUpC72ED9">
                  ...
                  <!--Gallery Item-->
                  <div
                     class="gallery-item-two mix <?php echo strtolower(str_replace(' ','_', $res_portfolio->category)); ?> col-lg-4 col-md-6 col-sm-12"
      ...
      <section class="ts-featured-cases" style="padding-bottom: 24px;">
         <div class="container">
            ...
            <div class="h4 lrg text-center"> Industry <span class="theme-red-color">We Serve</span></div><span
               class="red-border-line">&nbsp;</span>
                  ...
                  <div class="item">
                     <div class="featured-projects-content">
                        ...
                        <div class="features-slider-img pull-right">
                           <img
                              src="<?php echo base_url();?>asset/images/home/enterprise-ecommerce-software-solution.png"
                     ...
                     <div class="featured-projects-content">
                        <div class="featured-projects-text float-left">
                           ...
                           <p class="intro-desc">The launch of our E-waiter software system in the market has made the
                              ...
                              profitability and the customerâ€™s orders directly get sent to the kitchen. The job is
                              simplified and the waiter can monitor every tableâ€™s order taken, timely delivery and
                              payment.</p>
                           <p><a class="btn btn-primary" href="#getstarted"> Get Started</a></p>
                        </div>
                        <div class="features-slider-img float-right">
                  ...
                  <div class="inner-content">
                     <div class="icon-set">
                        <img src="<?php echo base_url();?>asset/images/reliable-services.png" alt="Unique talent pool"
                           title="Unique talent pool" width="auto" height="auto"></div>
