                                ...
                                <div class="job-info">
                                    ...
                                    <ul>
                                        <li class="vacancy-no">Number of Vacancy:
                                            <span><?php echo $res_career->no_of_vacancy; ?></span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="job-bottom-box">
                                <div class="title-container col-lg-5 col-md-6 col-sm-12">
                                    <div class="icon-box">
                                ...
                                <div class="skill-container col-lg-4 col-md-6 col-sm-12">
                                ...
                                <div class="btn-container col-lg-3 col-md-6 col-sm-12">
