...
<html lang="en">
    <head>
        ...
        <title>Web Design Company in Ooty | Website Design Ooty - Cloudi5</title>
        <meta name="description" content="Cloudi5 is the best Web design company in Ooty design websites with expertise that helps to elevate your business. Contact Us For More Information!" />
        <meta name="keywords" content="best web design company in Ooty, website design companies, website design in Ooty, web design companies in Ooty, Web Hosting, ecommerce design, corporate design, Web design companies in India, UK, US, Canada, Middle East Countries, best branding companies in Ooty, Website design, web page, top web design companies, Web design, Restuarants, Shopping sites, Taxi, Travels, Education sites design, Construction, Real estate website design, Hotel Booking website design" />
        <link rel="canonical" href="<?php echo base_url(); ?>/website-design-company-in-ooty" />
		<meta property="og:type" content="website" />
        <meta property="og:title" content="Web Design Company in Ooty | Website Design Ooty - Cloudi5" />
        <meta property="og:description" content="Cloudi5 is the best Web design company in Ooty design websites with expertise that helps to elevate your business. Contact Us For More Information!" />
        <meta property="og:url" content="<?php echo base_url(); ?>/website-design-company-in-ooty" />
        <meta name="robots" content="index,follow" />
        <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0" />
        <link rel="alternate" href="<?php echo base_url();?>website-design-company-in-ooty" hreflang="x-default" />
                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-5">
                            <div class="banner_iner">
                                <h1 class="text-gray-extra-dark no-margin-bottom"><span class="text-gradient-red">Website Design</span> Company in Ooty </h1>
...
"url": "<?php echo base_url(); ?>/website-design-company-in-Ooty",
...
"description": "Cloudi5 a leading Web design company in Ooty design websites with expertise that helps to elevate your business. Contact Us For More Information!",
