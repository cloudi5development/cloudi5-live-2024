...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>asset/css/social-media-marketing.css" />
    <!-- Owl Carousel-->
...
<body id="">
    <div class="body-inner social-media-marketing-page" id="">
            ...
            <div class="container banner-content">
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-10">
                        ...
                        <h2 class="title">Best <span>Social Media Marketing </span> Development Company in Coimbatore</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section>
        <div class="leading-smm-section mb-60">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-7 col-md-12 col-sm-12 left-leading-container">
                        <div class="leading-smm-title">
                            <p class="text-red text-bold">We don't just manage social media, we master it.</p>
                            <h2>Why choose Cloudi5 for your <br> Social Media Marketing?</h2>
                        </div>
                        <div class="dash-and-paragraph dash-1">
                            <div>
                                <img src="<?php echo base_url(); ?>asset/images/smm-page/list-type-icon.png" alt="bg-pattern" class="icon-list-type" />
                            </div>
                            <div>
                    ...
                    <div class="col-lg-5 col-md-12 col-sm-12  right-leading-container">
                        <div class="container">
                            ...
                            <img src="<?php echo base_url(); ?>asset/images/smm-page/social-media-bg.avif" alt="bg-pattern" class="smm-leading-right-img move-x" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <div class="media-card-left">
                                    <img src="<?php echo base_url(); ?>asset/images/smm-page/facebook-social-left.png" alt="bg-pattern" class="" />
                                </div>
                            </div>
                                ...
                                <div class="card-content-wrapper">
                                    <div class="card-text-wrapper">
                                        ...
                                        <p>Facebook is important for your brand, helping you reach more people, build a community, and stand out.
                                            ...
                                            Our targeted ads reach the right audience, and we use data-driven strategies and Meta Ads
                                            to target your desired audience effectively. Whether you aim for brand awareness, lead generation,
                                    ...
                                    <div class="card-text-wrapper">
                                        <div class="icon-wrapper">
                                            <button class="Btn">
                                                ...
                                                <span class="svgContainer">
                                                <img src="<?php echo base_url(); ?>asset/images/smm-page/instagram.svg" alt="pattern" class="social-icon" />
                                                </span>
                    ...
                    <div class="col-lg-12">
                        <div class="social-service-card-wrapper">
                            <div class="row">
                                ...
                                <!-- <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="service-card-wrapper card-wrapper-8">
                                        <div class="service-text-wrapper">
                                            <h3>Social Media Management</h3>
                                            <p>Don't get overwhelmed by the daily tasks of social media. Cloudi5's SMM experts become an extension of your team, handling everything from content scheduling and posting to engaging your audience and managing comments. We'll free up your time to focus on what matters most - running your business - while ensuring your social media presence stays active and successful.</p>
                                        </div>

                                        <div class="consulting consult-item-8">
                                            <img src="<?php echo base_url(); ?>asset/images/smm-page/service-media-8.png" alt="Media-Management-service-icon" class="service-icon" />
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="service-card-wrapper card-wrapper-9">
                                        <div class="service-text-wrapper">
                                            <h3>Social Media Management</h3>
                                            <p>Don't get overwhelmed by the daily tasks of social media. Cloudi5's SMM experts become an extension of your team, handling everything from content scheduling and posting to engaging your audience and managing comments. We'll free up your time to focus on what matters most - running your business - while ensuring your social media presence stays active and successful.</p>
                                        </div>

                                        <div class="consulting consult-item-9">
                                            <img src="<?php echo base_url(); ?>asset/images/smm-page/service-media-9.png" alt="Media-Management-service-icon" class="service-icon" />
                                        </div>
                                    </div>
                ...
                <div class="faq-container">
                    <div class="row justify-content-center">
                        <div class="faq-title col-md-8">
                            ...
                            <img src="<?php echo base_url(); ?>asset/images/webdesign-page-img/faq-pattern-2.webp" class="faq-pattern-2-wrapper spin" alt="faq-pattern-img">
                            <div>
                                    ...
                                    <div class="accordion-single">
                                        ...
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">There's no one-size-fits-all answer! It depends on your target audience and industry.
                                                    We'll help you identify the platforms where your ideal customers spend their time.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-single">
                                        ...
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">Consistency is key, but the ideal posting frequency varies by platform and audience. Cloudi5 will create a personalized posting schedule based on your unique needs and goals,
                                                    ensuring you stay top-of-mind with your followers without overwhelming them.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-single">
                                        ...
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">Data is king! Cloudi5 will set up comprehensive analytics dashboards to track key metrics like reach, engagement, website traffic, and lead generation.
                                                    This data will be used to optimize your campaigns and ensure you're achieving your social media goals.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-single">
                                        ...
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">Paid ads can be a powerful tool to boost your reach and target specific demographics. Cloudi5 will discuss your budget and goals to determine if paid ads are a good fit for your strategy.
                                                    We'll then manage your ad campaigns for maximum impact and return on investment.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-single">
                                        ...
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">Cloudi5 offers transparent pricing tailored to your specific
                                                    needs and budget. We have a range of packages to choose from, ensuring you get the level of service and support that's right for your business.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="accordion-single">
                                        <h5 class="header-area">
                                            <button type="button" class="accordion-btn d-flex align-item-center text-start w-100">
                                                What social media platforms does Cloudi5 specialize in?
                                            </button>
                                        </h5>
                                        <div class="content-area">
                                            <div class="content-body">
                                                <p class="content-desc">While Cloudi5 can manage a variety of social media platforms, we specialize in the big five: Facebook, Instagram, Twitter, LinkedIn, and YouTube.
                                                    We'll recommend the best mix for reaching your target audience.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
