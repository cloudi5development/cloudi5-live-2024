...
<head>
    ...
    <meta property="og:description"
        content="Cloudi5 is Best Software Development Company in Coimbatore, Tamil Nadu, India. we provide services for Android App & Web Development, web design, mobile app, Digital Marketing services including SEO, SEM, SMO, and SMM. Our major products are School ERP (School Management software) and Ecommerce software." />
            ...
            <div class="container">
                <div class="row text-center">
                    <div class="col-md-12">
                        ...
                        <h1 class="con-title"><span>Web design, Web Development, Mobile App Development & Digital
                                Marketing</span></h1>
                    </div>
                </div>
                    ...
                    <div class="">
                        <div class="contact-wrapper">
                            <div class="contact-box form-box">
                                <form class="contact-form" id="FormValidation"
                                    action="<?php echo base_url('contactform'); ?>" method="post"
                                        ...
                                        <div class="moonray-form-p2c21081f79 ussr">
                                            <div class="moonray-form moonray-form-label-pos-stacked">
                                                <div class="two-column">
                                                    <div class="two-column-left">
                                                        <div class="icon-set"><img
                                                                src="<?php echo base_url(); ?>asset/images/boy.png"
                                                                alt="First Name"></div>
                                                        <input type="text" name="website" class="form-control"
                                                            style="display:none;">
                                                        <input name="contactname" type="text"
                                                            class="required moonray-form-input" id=""
                                                    ...
                                                    <div class="two-column-right">
                                                        <div class="icon-set"><img
                                                                src="<?php echo base_url(); ?>asset/images/office.png"
                                                                alt="Business Name"></div>
                                                        <input name="businessname" type="text"
                                                            class="moonray-form-input" id=""
                                                            value="<?php echo set_value('businessname'); ?>"
                                                ...
                                                <div class="two-column">
                                                    <div class="two-column-left">
                                                        <div class="icon-set"><img
                                                                src="<?php echo base_url(); ?>asset/images/checklist.png"
                                                                alt="Office Phone"></div>
                                                        <div class="icon-set">
                                                            <img src="<?php echo base_url(); ?>asset/images/checklist.png"
                                                                alt="Office Phone">
                                                        </div>
                                                        <input name="contactphone" type="text"
                                                            class="moonray-form-input" id="contactphone"
                                                    ...
                                                    <div class="two-column-right">
                                                        <div class="email">
                                                            <div class="icon-set"><img
                                                                    src="<?php echo base_url(); ?>asset/images/contact-email.png"
                                                                    alt="Email"></div>
                                                ...
                                                <div class="one-column">
                                                    <div class="email">
                                                        <div class="icon-set"><img
                                                                src="<?php echo base_url(); ?>asset/images/project.png"
                                                                alt="Project Description"></div>
                                                        <textarea name="contactdescription"
                                                            class="required moonray-form-input" id=""
                                                            placeholder="Message*"><?php echo set_value('contactdescription'); ?></textarea>
                                    ...
                                    <div class="text-center padd-co">
                                        <button class="btn btn-primary tw-mt-30"  id="submit-button" type="submit">Submit </button>
                                    </div>
                                </form>
                            </div>
                            <div class="contact-box info-box">
                                <div class="contact-info-right">
                                    ...
                                    <div class="ts-contact-info">
                                        <span class="ts-contact-icon float-left"><i
                                                class="icon icon-map-marker2"></i></span>
                                        <div class="ts-contact-content">
                                            <h3 class="ts-contact-title">Find Us</h3>
                                            <p><?php echo $contact_setting->address_1; ?><br>
                                                <?php echo $contact_setting->address_2 .' '. $contact_setting->address_3; ?>
                                                <br><?php echo $contact_setting->city .' '. $contact_setting->pincode; ?>,
                                                <?php echo $contact_setting->state; ?>, India</p>
                                        </div>
                                    </div>
                                    <div class="ts-contact-info">
                                        ...
                                        <div class="ts-contact-content">
                                            ...
                                            <p><a href="tel:<?php echo str_replace(' ', '', $header_setting->mobile_2); ?>"
                                                    class="tel btns callus">Sales:
                                                    <?php echo $contact_setting->mobile_2; ?></p>
                                            <p><a href="tel:<?php echo str_replace(' ', '', $header_setting->mobile_1); ?>"
                                                    class="tel btns callus">Support:
                                                    <?php echo $contact_setting->mobile_1; ?></p>
                                            <p><a href="tel:+91959716798" class="tel btns callus">Careers: (+91) 95970
                                                    16798</p>
                                        </div>
                                    </div>
                                    <div class="ts-contact-info last">
                                        ...
                                        <div class="ts-contact-content">
                                            ...
                                            <p><img src="<?php echo base_url(); ?>asset/images/footer-mail.png"
                                                    alt="Mail Id"></p>
                                        </div>
                                    </div>
                                    <div class="Social-Footer">
                                        ...
                                        <ul class="icons-ul">
                                            <li class="facebook"><a href="<?php echo $contact_setting->facebook; ?>"
                                                    rel="nofollow" target="_blank"><span
                                                        class="fa fa-facebook hvr-icon-up"></span></a></li>
                                            <li class="twitter"><a href="<?php echo $contact_setting->twitter; ?>"
                                                    rel="nofollow" target="_blank"><img
                                                        src="https://www.cloudi5.com/asset/images/twitter-white-logo.png"
                                                        style="height:13px;"></a></li>
                                            <li class="instagram"><a href="<?php echo $contact_setting->instagram; ?>"
                                                    rel="nofollow" target="_blank"><span
                                                        class="fa fa-instagram hvr-icon-up"></span></a></li>
                                            <li class="linkedin"><a href="<?php echo $contact_setting->linkedin; ?>"
                                                    rel="nofollow" target="_blank"><span
                                                        class="fa fa-linkedin hvr-icon-up"></span></a></li>
                                            <li class="pinterest"><a href="<?php echo $contact_setting->pinterest; ?>"
                                                    rel="nofollow" target="_blank"><span
                                                        class="fa fa-pinterest hvr-icon-up"></span></a></li>
                                            <li class="youtube"><a href="<?php echo $contact_setting->youtube; ?>"
                                                    rel="nofollow" target="_blank"><span
                                                        class="fa fa-youtube hvr-icon-up"></span></a></li>
                                            <li class="thread"><a href="<?php echo $contact_setting->google_plus; ?>"
                                                    rel="nofollow" target="_blank"><span class=""><img
