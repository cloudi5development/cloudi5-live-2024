            ...
            <div class="table-cell width50">
               ...
               <div class="row table-cell-content">
                  <div class="">
                     <div class="ts-feature-box">
                        <div class="ts-feature-info icon-left">
                           ...
                           <div class="feature-content">
                              ...
                              <p>We transform browsers into buyers with secure and user-friendly online stores.</p>
                           </div>
                        </div>
                     </div>
                     <div class="ts-feature-box">
                        <div class="ts-feature-info icon-left">
                           ...
                           <div class="feature-content">
                              ...
                              <p>We orchestrate your business symphony with custom ERP solutions for streamlined
                                 operations.</p>
                           </div>
                        </div>
                     </div>
                     <div class="ts-feature-box">
                        <div class="ts-feature-info icon-left">
                           ...
                           <div class="feature-content">
                              ...
                              <p>We create the perfect fit for your digital needs with personalized software
                                 applications.</p>
                           </div>
                        </div>
                     </div>
                     <div class="ts-feature-box">
                        <div class="ts-feature-info icon-left">
                           ...
                           <div class="feature-content">
                              ...
                              <p>We build bridges on the customer journey with custom CRM software for lasting
                                 relationships. </p>
                           </div>
                        </div>
                     </div>
                     <div class="ts-feature-box">
                        <div class="ts-feature-info icon-left">
                           <span class="feature-icon web-app-develop">
                              <img src="<?php echo base_url(); ?>asset/images/web-programming.png">
                           </span>
                           <div class="feature-content">
                              <h3 class="ts-feature-title">Web Application Development</h3>
                              <p>We transform your ideas into powerful web applications, ensuring they run smoothly and
                                 scale effectively.</p>
                           </div>
                        </div>
                     </div>
         ...
         <div class="container">
            <div class="row r-and-d">
               ...
               <div class="col-sm-7 col-xs-12 text-left">
                  ...
                  <p class="aos-animate aos-init" data-aos="fade-up">You can count on our careful root-cause analysis,
                     interface architecture and design experience, post-analysis for a refined final product that is
                     equally stunning and easy-to-use across all platforms.</p>
            ...
            <div class="row ui-ux">
               <div class="col-sm-7 col-xs-12 text-left">
                  ...
                  <p class="aos-animate aos-init" data-aos="fade-up">We will help you build an engaging product easily
                     and quickly with a clear design process that delivers an ideal end result.</p>
                  <ul class="dotLinks aos-animate aos-init" data-aos="fade-up">
         ...
         <div class="container">
            <div class="row dev-test-debug">
               ...
               <div class="col-sm-7 col-xs-12 text-left">
                  ...
                  <p class="aos-animate aos-init" data-aos="fade-up">We design, develop and deliver the product that is
                     highly functional and built with great features. In addition to that, you can also expand your
                     portal and extend its functionally in future.</p>
                  <ul class="dotLinks aos-animate aos-init" data-aos="fade-up">
            ...
            <div class="row justify-content-center align-items-center">
               ...
               <div class="col-lg-6 align-self-center">
                  <div class="owl-carousel owl-theme testimonial-slide owl-dark" id="testimonial-slide">
                     <div class="item">
                        <div class="quote-item quote-square"><span class="quote-text">I approached them to revamp my
                     ...
                     <div class="item">
                        <div class="quote-item quote-square"><span class="quote-text">They are a pleasure to work with.
                              Their experienced team is quick to offer any assistance that we require. I am really
                     ...
                     <div class="col-lg-4">
                        <div class="portfolio-content-container">
                           <div class="portfolio-logo">
                              <img src="<?php echo base_url(); ?>asset/images/portfolio-new/sanlak-logo.png"
                                 alt="sanlak-logo">
                           </div>
                           <h3>Santhana Lakshmi Metals</h3>
                           <p>Trader of an extensive array of Aluminium Products, Stainless Steel Products, Brass
                              Products, Copper Products, Aluminium Circle and many more.</p>
                        </div>
                        <div class="portfolio-global-store">
                           <a href="https://www.sanlak.in/" target="_blank">
                        ...
                        <div class="portfolio-content-container">
                           <div class="portfolio-logo">
                              <img src="<?php echo base_url(); ?>asset/images/portfolio-new/mayflower-logo-1.png"
                                 alt="mayflower-logo-1">
                           </div>
                           <h3>Mayflowerenterprises</h3>
                           <p>Mayflower® Enterprises has been a proud and accomplished name in the community since its
                              inception.</p>
                        </div>
                        <div class="portfolio-global-store">
