               ...
               <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                  <ul class="navbar-nav">
                     ...
                     <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Services<i
                              class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu" role="menu">
                           <li><a href="<?php echo base_url(); ?>website-design-company-in-coimbatore">Website Design</a>
                           </li>
                     ...
                     <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Products<i
                        ...
                        <ul class="dropdown-menu" role="menu">
                           ...
                           <li class="nav-item"><a href="<?php echo base_url(); ?>multi-vendor-ecommerce-website">Multi
