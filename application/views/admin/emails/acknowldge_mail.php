                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 20px 30px;line-height:20px">Hi <span><?php echo $name;?></span>,											
                                            </td>
											
                                        </tr>
										<tr>
                                            <td valign="top" width="250" style="background-color:#ffffff;font-size: 20px;font-family:Arial,sans-serif;text-align:left;padding: 0px 10px 20px 0px;line-height:20px;font-weight: 600;"><center>Thank you for Contacting us.</center>
                                                </td>
                                           
                                        </tr>
										<tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:0px 10px 0px 30px;line-height:20px">
											We appreciate that you’ve taken the time to Contacting us. We’ll get back to you very soon. For urgent enquiries please call us at :<br><br>
											<b>Phone : </b> <a href="tel:<?php echo $setting->mobile_1;?> " style="text-decoration:none;color:#49ba8e" target="_blank"><?php echo $setting->mobile_1;?></a><br>
											<b>Email : </b><a href="mailto:<?php echo $setting->email_id_1;?>" style="text-decoration:none;color:#49ba8e;font-weight:bold" target="_blank"><?php echo $setting->email_id_1;?></a><br>											
                                            </td>
                                        </tr>
