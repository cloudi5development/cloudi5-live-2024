                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 10px 30px;line-height:20px">Hi <span><?php echo  $name;?></span>,<br><br>
											The password for your <?php echo ucwords($setting->site_name);?> Account <?php echo $email ?> was recently changed.
                                            </td>
                                        </tr>
										 <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:10px 10px 20px 30px;line-height:20px"><?php echo ucwords($setting->site_name);?> Team
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
