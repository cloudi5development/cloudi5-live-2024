                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 0px 30px;line-height:20px">Hi <span><?php echo $email ?></span>,
											</td>
                                        </tr>
										<tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 20px 30px;line-height:20px">
											Your <?php echo ucwords($setting->site_name);?> Account has been created. <br>You can use your Email( <?php echo $email;?> ) to accesspanel/ reset your password in future.
											<br><br>Before you can login to your account or use, you first need to create a secure password.
                                            </td>
                                        </tr>
										<tr>
											...
											<a href="<?php echo base_url();?>accesspanel/create_password/<?php echo $token?>" style="font-weight:500;color:#ffffff;text-decoration:none" target="_blank">Create Your Password</a>
											</td>
										</tr>
										 <tr>
