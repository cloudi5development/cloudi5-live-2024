                            ...
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
										...
										<tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:20px 10px 0px 30px;line-height:20px">
											<b> Status : </b> <?php if($status ==1){ echo "Approval";} else { echo "Pending"; };?>
                                            </td>
                                        </tr>
										<tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:20px 10px 0px 30px;line-height:20px">
										 ...
										 <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:20px 10px 20px 30px;line-height:20px">The Cloudi5  Team
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
