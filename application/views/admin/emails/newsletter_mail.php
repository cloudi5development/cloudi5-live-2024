						...
						<tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="250" style="background-color:#ffffff;color: #0929c9;font-size: 20px;font-family:Arial,sans-serif;text-align:left;padding: 20px 10px 0px 0px;line-height:20px;font-weight: 600;"><center>Newsletter Enquiry Form</center>
                                                </td>
                                        </tr>
                                    </tbody>
                                </table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 20px 30px;line-height:20px">Hi <span>Admin</span>,
                                                <br>We received newsletter enquiry from <b> <?php echo $name; ?></b>! </td>
