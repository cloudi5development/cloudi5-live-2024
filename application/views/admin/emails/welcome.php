                        ...
                        <tr>
                            <td valign="top">
                                <table cellpadding="0" cellspacing="0" width="600" border="0" align="center">
                                    <tbody>
                                        <tr>
                                            <td valign="top" width="500" style="background-color:#ffffff;color:#666666;font-size:15px;font-family:Arial,sans-serif;text-align:left;padding:30px 10px 20px 30px;line-height:20px">Hi <span><?php echo  $name;?></span>,<br><br>
											Thanks for creating a <?php echo ucwords($setting->site_name);?>. Your <?php echo $verify;?> has been verified and linked to your account. You can use your Email(<?php echo $email;?>) to accesspanel/ reset your password in future. 
                                            </td>
                                        </tr>
										 <tr>
