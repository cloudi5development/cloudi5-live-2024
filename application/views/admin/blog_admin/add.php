			...
			<div class="col-md-12">
				<div class="card">
					...
					<div class="card-body collapse in">
					 ...
					 <?php
							//echo get_form_tag($save_blog);?>
							<form class="form form-horizontal" method="post" action="<?php echo base_url();?>blog_admin/save_blog" enctype="multipart/form-data">	
							<div class="row">
								<div class="col-md-12">
									<div class="col-md-6">
									...
									<?php
										echo get_input_tag_required('text','Blog Date','blog_date','','datepicker');
										echo get_input_tag_required('text','Title','title','','');
									?>
									<div class="form-group row">
                    					<label class="col-md-3 label-control">Image<span class="required">*</span></label>
                    					<div class="col-md-9">
                    					  <input type="file" name="image" errorCode="errorCodeimage" class="fileUpload image required form-control"> 
									...
									<?php
										...
										echo get_input_tag('text','Author Name','author_name','','','Cloudi5');
									?>
									<div class="form-group row">
