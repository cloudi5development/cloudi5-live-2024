	        ...
	        <div class="card">
	            ...
	            <div class="card-body collapse in">
	                <div class="card-block">
						<?php 
							 echo get_data_table('tableEnquiries',array('Enquiry Date','IP','Name','Email','Mobile','Subject','Message','Actions'));
...
$(document).ready(function() {
   ...
   var tableEnquiries = $('#tableEnquiries').DataTable({ 
		...
		"ajax": $.fn.dataTable.pipeline({
			...
			"url": "<?php echo site_url('enquiries/enquiries_list')?>",
			method: "POST",
		}),
		"columnDefs": [
		{ 
	...
	$(document).on('click', '#ViewEnquiry', function(e){
		...
		$('#View-Enquiries-Content').html('');
			$.ajax({
				...
				dataType: 'html',
				url: '<?php echo base_url();?>enquiries/view',
		...
		title: 'Delete!', backgroundDismiss: false, alignMiddle: true, backgroundDismissAnimation: 'glow', buttons: {
			Delete: {
				text: 'Delete', btnClass: 'btn-danger', action: function() {
					window.location='<?php echo base_url('enquiries/delete_enquiry'); ?>/'+id;
				}
			}, cancel: function () {},
		}
	}
