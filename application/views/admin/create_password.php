			...
			<?php echo message_box('error'); ?>
				<fieldset class="form-group">
					<div class=" text-xs-center ">
						<fieldset>
							<p>To Create your new password,provide the following information,and then click Submit.</p>
						</fieldset>
					</div>
				</fieldset>
				<form class="formhorizontal" id="FormValidation" method="POST" action="<?php echo base_url('accesspanel/create_password_submit');?>">	
					...
					<fieldset class="form-group has-feedback has-icon-left">
						<input type="password" class="form-control required input-lg" id="password" name="new_password" value="<?php echo set_value('new_password'); ?>"  placeholder="Enter Password" tabindex="2" >
					...
					<fieldset class="form-group has-feedback has-icon-left">
						<input type="password" class="form-control required input-lg" id="password" name="conform_password" value="<?php echo set_value('conform_password'); ?>"  placeholder="Confirm Password" tabindex="2" >
						<div class="form-control-position">
						    <i class="icon-key3"></i>
						</div>
						<div class="help-block font-small-3"></div>
					...
					<button type="submit" class="btn btn-danger btn-block btn-lg"><i class="icon-unlock2"></i>Submit</button>
				</form>
			</div>
		</div>
