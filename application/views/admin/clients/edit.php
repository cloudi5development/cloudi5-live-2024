                        ...
                        <div class="card">
                            ...
                            <div class="card-body collapse in">
                                <div class="card-block">
                                    <?php
							echo get_form_tag($update_clients);?>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-6">
                                                <?php
										echo get_input_tag_required('text','Name','name','','',$clients->name);
										echo get_input_tag_required('text','Priority','priority','','',$clients->priority);
									?>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <img src="<?php echo base_url() . $clients->image;?>"
                                                ...
                                                <?php
										echo get_input_tag('text','Image Alt Tag','image_alt_tag','','',$clients->image_alt_tag);
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    <?php echo ($clients->is_show_in_home == 1) ? 'checked' : ''; ?>>
                                                                Is Show In Home
                                                            </label>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input required"
                                                                       ...
                                                                       value="1"
                                                                        <?php echo ($clients->status == 1) ? 'checked' : ''; ?>>
                                                                    Active
                                                                </label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <label class="form-check-label">
                                                                    <input class="form-check-input required"
                                                                        ...
                                                                        value="0"  <?php echo ($clients->status == 0) ? 'checked' : ''; ?>>
                                                                    Inactive
                                                                </label>
                                                            </div>
                                                        </div>
