...
class Enquiries_model extends MY_Model{
	...
	public $_table_name = 'contacts';
    public $_order_by = 'ci5_id';
    public $_primary_key = 'ci5_id';
	
	public function getAll()
  	{
		return $this->db->order_by('ci5_id','asc')->get($this->_table_name)->result();
  	}
	...
	var $column_order = array(Null,'ip','name','email','phone','subject','comments'); 
	var $column_search = array('ip','name','email','phone','subject','comments'); 
	var $order = array('cteated_at' => 'DESC'); 
