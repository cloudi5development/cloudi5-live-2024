...
class Testimonials_model extends MY_Model{
	...
	public $_table_name = 'testimonials';
    public $_order_by = 'testimonial_id';
    public $_primary_key = 'testimonial_id';
	...
	var $column_order = array(Null,'title','image','message','status'); 
	var $column_search = array('title','image','message','status'); 
